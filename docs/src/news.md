...
- Cut-off (26 May): 1077 suspected cases, 238 suspected deaths, 121
  confirmed, 403 samples analysed. The per-vintage history runs 18-26 May;
  23 May deaths use the SitRep 009 zone-row sum (220), the headline (119)
  being a data-entry error.
- Showed the laboratory streams and the per-vintage time series in the
  data table, and cited the INSP reports and the INRB-UMIE archive.
