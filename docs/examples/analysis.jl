...
#
# **How the numbers may differ from McCabe et al.** Our estimates can differ
...
# the reported counts in the data table below. These can sometimes differ
# from the exact data cut-offs used in the reports. For example, they
# match the 20 May report's deaths and cases ($131$ and $516$) but are more
# recent than the 16 May 2026 figures the 18 May report used (e.g. $88$ suspected
# deaths). The joint
