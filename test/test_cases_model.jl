...
@testsnippet CasesModelFixtures begin
...
@testitem "cases_model prior draws finite reported_cases" tags=[:slow] setup=[CasesModelFixtures] begin
...
@testitem "cases_only_model fits a tiny observation" tags=[:slow] setup=[CasesModelFixtures] begin
    using Turing: sample, Prior
    import FlexiChains
